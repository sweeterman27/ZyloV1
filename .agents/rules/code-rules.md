...
## 🎯 VIEWPORT SCOPING DIRECTIVES (USER PREFERENCE - MANDATORY)

- **`MOBILE VIEW`**: Modify ONLY mobile view styling/code (base CSS / Tailwind classes without breakpoint prefixes like `py-4`, `text-xs`). **DO NOT** modify desktop responsive classes (`sm:`, `md:`, `lg:`, `xl:`).
- **`DESKTOP VIEW`**: Modify ONLY desktop view styling/code (breakpoint prefixes `sm:`, `md:`, `lg:`, `xl:`, `2xl:`). **DO NOT** modify base mobile classes.
- **`UNIVERSAL VIEW`**: Modify both mobile and desktop styling.
